###########################################################################
## Makefile generated for Simulink model 'target_generation_lib0'. 
## 
## Makefile     : target_generation_lib0.mk
## Generated on : Fri May 03 16:51:03 2019
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/target_generation_lib0
...
PRODUCT_NAME              = target_generation_lib0
MAKEFILE                  = target_generation_lib0.mk
COMPUTER                  = MACI64
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/Taylor/uw_cubesat_adcs/adcs/sw/components/adcs_fsw/matlab/test/fsw-autocode-test/target_generation
ARCH                      = maci64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
MODELREF_LINK_RSPFILE_NAME = target_generation_lib0_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/target_generation_lib0
...
INCLUDES_BUILDINFO = -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/target_generation_lib0_ert_rtw -I$(START_DIR) -I/Users/Taylor/uw_cubesat_adcs/adcs/sw/components/adcs_fsw/matlab/test/target-generation-test -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=target_generation_lib0 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
SRCS = $(START_DIR)/target_generation_lib0_ert_rtw/target_generation_lib0.c

MAIN_SRC = $(START_DIR)/target_generation_lib0_ert_rtw/ert_main.c
...
%.o : $(START_DIR)/target_generation_lib0_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/target_generation_lib0_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"

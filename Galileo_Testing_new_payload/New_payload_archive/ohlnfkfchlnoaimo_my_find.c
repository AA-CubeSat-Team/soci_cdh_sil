 ...
 *
 * File: ohlnfkfchlnoaimo_my_find.c
 *
 ...
 */
void ohlnfkfchlnoaimo_my_find(const real_T X_3[38844], real_T Xir[1278], real_T
  Xpr[1278])
{
  uint32_T id;
  int32_T row;

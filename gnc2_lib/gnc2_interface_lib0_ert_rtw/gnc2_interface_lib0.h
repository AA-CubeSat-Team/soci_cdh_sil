...
#ifndef RTW_HEADER_gnc2_interface_lib0_h_
#define RTW_HEADER_gnc2_interface_lib0_h_
#include "rtwtypes.h"
#include "zero_crossing_types.h"
#include <math.h>
#include <string.h>
#ifndef gnc2_interface_lib0_COMMON_INCLUDES_
# define gnc2_interface_lib0_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "zero_crossing_types.h"
#include "ecos.h"
#endif                                 /* gnc2_interface_lib0_COMMON_INCLUDES_ */
...
typedef struct {
  ...
  ZCSigState gnc2_lib_Trig_ZCE;        /* '<S1>/gnc2_lib' */
} PrevZCX;
...
extern void gnc2_interface_lib0_initialize(void);
extern void gnc2_interface_lib0_step(void);
extern void gnc2_interface_lib0_terminate(void);
 ...
 *
 * hilite_system('gnc2_autocode_test/gnc2_interface_lib')    - opens subsystem gnc2_autocode_test/gnc2_interface_lib
 * hilite_system('gnc2_autocode_test/gnc2_interface_lib/Kp') - opens and selects block Kp
 *
 * Here is the system hierarchy for this model
 *
 * '<Root>' : 'gnc2_autocode_test'
 * '<S1>'   : 'gnc2_autocode_test/gnc2_interface_lib'
 * '<S2>'   : 'gnc2_autocode_test/gnc2_interface_lib/Compare To Constant'
 * '<S3>'   : 'gnc2_autocode_test/gnc2_interface_lib/Detect Rise Positive'
 * '<S4>'   : 'gnc2_autocode_test/gnc2_interface_lib/INTERP'
 * '<S5>'   : 'gnc2_autocode_test/gnc2_interface_lib/gnc2_lib'
 * '<S6>'   : 'gnc2_autocode_test/gnc2_interface_lib/Detect Rise Positive/Positive'
 * '<S7>'   : 'gnc2_autocode_test/gnc2_interface_lib/gnc2_lib/INITIALIZE'
 * '<S8>'   : 'gnc2_autocode_test/gnc2_interface_lib/gnc2_lib/SOLVE'
 * '<S9>'   : 'gnc2_autocode_test/gnc2_interface_lib/gnc2_lib/call to ECOS SOCP solver (compiled C function)'
 */
#endif                                 /* RTW_HEADER_gnc2_interface_lib0_h_ */

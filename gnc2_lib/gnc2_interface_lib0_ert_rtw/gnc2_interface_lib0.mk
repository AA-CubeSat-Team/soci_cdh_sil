###########################################################################
## Makefile generated for Simulink model 'gnc2_interface_lib0'. 
## 
## Makefile     : gnc2_interface_lib0.mk
## Generated on : Fri May 24 16:45:06 2019
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/gnc2_interface_lib0
...
PRODUCT_NAME              = gnc2_interface_lib0
MAKEFILE                  = gnc2_interface_lib0.mk
COMPUTER                  = MACI64
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/Taylor/uw_cubesat_adcs/adcs/sw/components/adcs_oac/test/gnc2_autocode_test
ARCH                      = maci64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
MODELREF_LINK_RSPFILE_NAME = gnc2_interface_lib0_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/gnc2_interface_lib0
...
INCLUDES_BUILDINFO = -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/gnc2_interface_lib0_ert_rtw -I$(START_DIR) -I/Users/Taylor/uw_cubesat_adcs/adcs/sw/components/adcs_oac/include/ecos/include -I/Users/Taylor/uw_cubesat_adcs/adcs/sw/components/adcs_oac/include/ecos/src -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(START_DIR)/slprj/ert/_sharedutils
...
DEFINES_STANDARD = -DMODEL=gnc2_interface_lib0 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
OBJS = gnc2_interface_lib0.o timer.o amd_1.o amd_2.o amd_aat.o amd_control.o amd_defaults.o amd_dump.o amd_global.o amd_info.o amd_order.o amd_post_tree.o amd_postorder.o amd_preprocess.o amd_valid.o cone.o ctrlc.o ecos.o equil.o expcone.o kkt.o ldl.o matlab_main.o preproc.o runecos.o spla.o splamm.o wright_omega.o
...
%.o : $(START_DIR)/gnc2_interface_lib0_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/gnc2_interface_lib0_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : /Users/Taylor/uw_cubesat_adcs/adcs/sw/components/adcs_oac/build/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : /Users/Taylor/uw_cubesat_adcs/adcs/sw/components/adcs_oac/build/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"

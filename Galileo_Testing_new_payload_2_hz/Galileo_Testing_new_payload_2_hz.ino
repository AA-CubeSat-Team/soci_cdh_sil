...
int stop = 0;
float FREQUENCY_IN_HZ = 10.0;
uint32_t period = (1.0 / FREQUENCY_IN_HZ) * 1E3;
uint32_t START = 0;
...
void Print_Results_2(ExtY result) {
  for(int i = 0; i < 3; i++) {
    Serial.print(result.command_torque[i]);
    Serial.print(", ");
  }
...
double toSeconds(double microseconds) {

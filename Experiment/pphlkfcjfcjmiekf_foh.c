  ...
  AR[100])
{
  ...
  for (k = 0; k < 9; k++) {
    ...
    for (k_ = 0; k_ < 9; k_++) {
      ...
      /* '<S3>:1:162' h       = tkp1-tk; */
      h = tspan[1 + k_] - tspan[k_];

      /* '<S3>:1:164' k1 = deriv(tk    ,P0       ,u,tspan,s,J); */
      ecbagdjmpphdgdjm_deriv(tspan[k_], P0, u, tspan, s, J, k1);
      ...
      ecbagdjmpphdgdjm_deriv(h / 2.0 + tspan[k_], P0_0, u, tspan, s, J, k2);
      ...
      ecbagdjmpphdgdjm_deriv(h / 2.0 + tspan[k_], P0_0, u, tspan, s, J, k3);
      ...
      ecbagdjmpphdgdjm_deriv(tspan[k_] + h, P0_0, u, tspan, s, J, k4);
    ...
    for (i_0 = 0; i_0 < 10; i_0++) {
      memcpy(&EH[(i_0 * 100 + i) + k_ * 100], &Ad[i_0 * 10], 10U * sizeof(real_T));
    }
    ...
    for (i_0 = 0; i_0 < 10; i_0++) {
      for (i_1 = 0; i_1 < 3; i_1++) {
        BE[(i_0 + i) + 100 * (i_1 + k_)] = 0.0;
        for (g_k = 0; g_k < 10; g_k++) {
          BE[(i_0 + i) + 100 * (i_1 + k_)] = BE[((i_1 + k_) * 100 + i_0) + i] +
            Ad[10 * g_k + i_0] * c_y[10 * i_1 + g_k];
        }
      }
    }
    ...
    for (g_k = 0; g_k < 10; g_k++) {
      for (i_0 = 0; i_0 < 3; i_0++) {
        BE[(g_k + i) + 100 * (i_0 + k_)] = 0.0;
        for (i_1 = 0; i_1 < 10; i_1++) {
          BE[(g_k + i) + 100 * (i_0 + k_)] = BE[((i_0 + k_) * 100 + g_k) + i] +
            Ad[10 * i_1 + g_k] * c_y[10 * i_0 + i_1];
        }
      }

      tspan[g_k] = P0[g_k + 170];
    }
    ...
    for (k_ = 0; k_ < 10; k_++) {
      Ad_0[k_] = 0.0;
      for (i_0 = 0; i_0 < 10; i_0++) {
        Ad_0[k_] += Ad[10 * i_0 + k_] * tspan[i_0];
      }
